...
namespace Nx.Tests.Annotations
{
  /// <summary>
  ...
  /// <item>Input    ::= ParameterName: Data [, Input]*</item>
  /// <item>Output   ::= [ParameterName: Data]* {halt|stop|void|nothing|Data}</item>
  /// <item>Data    ::= true | false | null | notnull | canbenull</item>
  /// </list>
